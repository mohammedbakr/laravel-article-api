  ...
  methods: {
    ...
    deleteArticle: function deleteArticle(id) {
      ...
      if (confirm('Are You Sure?')) {
        axios["delete"]("/api/articles/".concat(id)).then(function (res) {
    ...
    addArticle: function addArticle() {
      ...
      if (this.edit === false) {
        ...
        axios.put("/api/articles/".concat(this.article_id), {
          id: this.article.id,
          title: this.article.title,
          body: this.article.body
        }).then(function (res) {
  ...
  return _c(
    ...
    [
      ...
      _c(
        ...
        { staticClass: "px-6" },
        [
          _c("h1", { staticClass: "font-bold text-2xl text-gray-900 mt-2" }, [
            _vm._v("Articles")
          ]),
          _vm._v(" "),
          _c(
            ...
            [
              _c("div", [
                _c("input", {
                  ...
                  staticClass: "w-full rounded p-3 focus:outline-none",
                  attrs: {
                    id: "title",
                    type: "text",
                    name: "title",
              ...
              _c(
                ...
                {
                  staticClass:
                    "bg-blue-500 text-white p-2 rounded-lg mt-2 w-full focus:outline-none",
                  attrs: { type: "submit" }
                },
                [_vm._v("Add Article")]
              )
          ...
          _vm._v(" "),
          _c("ul", { staticClass: "flex border rounded bg-white mt-6" }, [
            _c(
              "li",
              {
              ...
              [
                _c(
                  "a",
                  {
                    staticClass: "block text-blue-400 border-r px-3 py-2",
                    attrs: { href: "#" },
                    on: {
            ...
            _c(
              ...
              [
                _c(
                  "a",
                  {
                    staticClass: "block text-blue-400 p-2",
                    attrs: { href: "#" },
                    on: {
                      click: function($event) {
          ...
          _vm._l(_vm.articles["data"], function(article, index) {
            return _c(
              ...
              {
                key: index,
                staticClass: "rounded shadow-sm px-6 py-4 bg-white mt-2 mb-2"
              },
              [
                _c(
                  "div",
                  { staticClass: "font-bold text-xl mb-2 text-gray-600" },
                  [_vm._v(_vm._s(article.data.title))]
                ),
                _vm._v(" "),
                _c("p", {}, [_vm._v(_vm._s(article.data.body))]),
                _vm._v(" "),
                _c(
                  "button",
                  {
                    staticClass:
                      "bg-yellow-600 rounded-lg text-white w-full p-1 mt-2 focus:outline-none",
                    on: {
                      click: function($event) {
                        return _vm.editArticle(article.data)
                      }
                    }
                  },
                  [_vm._v("Edit")]
                ...
                _c(
                  ...
                  {
                    staticClass:
                      "bg-red-600 rounded-lg text-white w-full p-1 mt-2 focus:outline-none",
                    on: {
                      click: function($event) {
                        return _vm.deleteArticle(article.data.id)
                      }
                    }
                  },
                  [_vm._v("Delete")]
...
var staticRenderFns = [
  function() {
    ...
    return _c(
      ...
      {
        staticClass:
          "bg-blue-400 text-white py-4 px-6 flex items-center text-bold text-xl border-b border-gray-500 shadow-sm"
      },
      [_c("a", { attrs: { href: "#" } }, [_vm._v("Lara Article")])]
    )
  }
]
render._withStripped = true
...
__webpack_require__(/*! C:\xampp\htdocs\Laravel\larart_api\resources\js\app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! C:\xampp\htdocs\Laravel\larart_api\resources\sass\app.scss */"./resources/sass/app.scss");
